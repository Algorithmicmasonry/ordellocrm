...
export default async function AiSandboxPage() {
  ...
  return (
    <ComingSoonOverlay
      ...
      description="The AI agent testing sandbox lets you trigger real calls with fake orders so you can fine-tune your AI before going live."
    >
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-yellow-50 dark:bg-yellow-950 border border-yellow-300 dark:border-yellow-700 rounded-lg p-4 space-y-1">
          ...
          <p className="text-sm text-yellow-800 dark:text-yellow-200">
            Orders submitted via the sandbox form are assigned directly to the
            AI agent and will trigger a real Vapi call (if{" "}
